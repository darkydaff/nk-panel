...
class PanelImporter
{
    ...
    private function createClientWithKeys(array $clientData): int
    {
        ...
        // Generate config if possible
        // Actually, we don't need a separate generateConfig call if we just wanted to sync.
        // But we should probably populate the config column so it's not empty in the UI.
        // For now, we'll leave it as empty or wait for first sync.
